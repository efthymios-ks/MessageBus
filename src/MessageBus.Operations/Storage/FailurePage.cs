...
/// <summary>One page of failure results.</summary>
/// <param name="Failures">Rows on this page.</param>
/// <param name="TotalCount">Total rows matching the filter across every page.</param>
/// <param name="Page">One-based page number.</param>
/// <param name="PageSize">Rows per page.</param>
public sealed record FailurePage(
    IReadOnlyList<FailureSummary> Failures,
    int TotalCount,
    int Page,
    int PageSize
)
